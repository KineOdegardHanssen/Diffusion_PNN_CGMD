...
ax2.loglog(psigmas, theoryall_graph, '--', label=r'A$a^{b}$')
ax2.set_xlabel(xlabel=r'$a$ (nm)',labelpad=-1.5,fontsize=12)#14)
ax2.set_ylabel(ylabel=r'$D$ (m$^2$/s)',labelpad=-3,fontsize=12)#14)
...
print('theoryall_graph:',theoryall_graph)
plt.show()
