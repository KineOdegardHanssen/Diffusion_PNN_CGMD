...
ax.plot(fitds,Ds_op_dyn, '--', label=r'op') # I have most values for the dynamic brush
ax.plot(fitds,Ds_hr_dyn, '-.', label=r'hr') # 2
...
ax.plot(fitds,Ds_p2_dyn, '-.', label=r'pl 2')
...
ax.plot(fitds,Ds_op_stat, '--', label=r'op') # I have most values for the dynamic brush
ax.plot(fitds,Ds_hr_stat, '-.', label=r'hr') # 2
...
ax.plot(fitds,Ds_p2_stat, '-.', label=r'pl 2')
...
ax.plot(fitds,Ds_op_dyn_perp, '--', label=r'op') # I have most values for the dynamic brush
ax.plot(fitds,Ds_hr_dyn_perp, '-.', label=r'hr') # 2
...
ax.plot(fitds,Ds_p3_dyn_perp, '--', label=r'pl')# 3')
ax.plot(fitds,Ds_p2_dyn_perp, '--', label=r'pl 2')# 3')
...
ax.plot(fitds,Ds_op_stat_perp, '--', label=r'op') # I have most values for the dynamic brush
ax.plot(fitds,Ds_hr_stat_perp, '-.', label=r'hr') # 2
...
ax.plot(fitds,Ds_p3_stat_perp, '--', label=r'pl')# 3')
ax.plot(fitds,Ds_p2_stat_perp, '-.', label=r'pl 2')
